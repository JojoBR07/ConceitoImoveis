            <!-- ##########################################################################
            // FOTER: Rodapé presente em todas as paginas do site      
            ############################################################################-->
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Conceito Imóveis 2020</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="../validation/logout.php">Logout</a>
                    </div>
                </div>
            </div>
        </div>
